...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 60.0, 54.0, 22.0 ],
					"text" : "onecopy"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 15.0, 420.0, 22.0, 22.0 ],
									"text" : "t b"
								}
...
,
									"patching_rect" : [ 315.0, 390.0, 69.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 131.0, 435.0, 71.0, 22.0 ],
									"text" : "fromsymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 540.0, 38.0, 22.0 ],
									"text" : "zl reg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 600.0, 51.0, 22.0 ],
									"text" : "pcontrol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 570.0, 79.0, 22.0 ],
									"text" : "prepend load"
								}
...
,
									"patching_rect" : [ 245.5, 390.0, 46.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 131.0, 345.0, 133.5, 22.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 131.0, 555.0, 72.0, 22.0 ],
									"text" : "prepend set"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 131.0, 390.0, 105.0, 22.0 ],
									"saved_object_attributes" : 									{
										"filename" : "mb-examples.js",
										"parameter_enable" : 0
									}
,
									"text" : "js mb-examples.js"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 62.0, 570.0, 53.0 ],
									"presentation" : 1,
									"presentation_linecount" : 3,
									"presentation_rect" : [ 15.0, 62.0, 570.0, 53.0 ],
									"text" : "Learning by examples is a powerful tool both creatively and technologically. Below are various example patches from pieces composed with the MetaBow as well as some examples of ideas that you might want to explore."
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 140.5, 579.0, 140.5, 579.0 ],
									"source" : [ "obj-38", 0 ]
								}
