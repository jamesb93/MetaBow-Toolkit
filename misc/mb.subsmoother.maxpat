...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 103.0, 126.0, 54.0, 22.0 ],
					"text" : "route list"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 126.0, 86.0, 22.0 ],
					"text" : "prepend mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.5, 126.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 273.5, 15.0, 53.0, 48.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 165.0, 15.0, 46.5, 90.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 15.0, 180.0, 106.5, 22.0 ],
					"text" : "gate 3 1",
					"varname" : "mode_gate"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 68.25, 240.0, 69.5, 240.0 ],
					"source" : [ "obj-28", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 112.0, 231.0, 237.25, 231.0 ],
					"source" : [ "obj-28", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 69.5, 300.0, 24.5, 300.0 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 112.5, 150.0, 112.0, 150.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 237.25, 300.0, 24.5, 300.0 ],
					"source" : [ "obj-40", 0 ]
				}
