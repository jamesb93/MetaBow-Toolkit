...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 195.0, 179.0, 165.0, 151.0 ],
									"proportion" : 0.5
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 330.0, 540.0, 150.0, 60.0 ],
									"text" : "The accelerometer abstraction outputs new sanitised data with the accelerometer identifier."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 375.0, 195.0, 150.0, 127.0 ],
									"text" : "Create some synthetic data with the identifier of 'accelerometer'. The accelerometer processor is expecting to receive messages with this identifier and knows how to interpret it. The gyro data is ignored."
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 345.0, 195.0, 180.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 15.0, 510.0, 45.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 179.0, 165.0, 151.0 ],
									"proportion" : 0.5
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									"destination" : [ "obj-3", 0 ],
									"midpoints" : [ 219.5, 338.0, 39.5, 338.0 ],
									"source" : [ "obj-1", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 39.5, 544.0, 305.5, 544.0 ],
									"source" : [ "obj-3", 0 ]
								}
...
,
					"patching_rect" : [ 180.0, 15.0, 79.0, 22.0 ],
...
,
					"patching_rect" : [ 90.0, 15.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
